...
def generate_mock_advice(problem):
...
if st.sidebar.button("Get Investment Advice"):
    if investment_problem:
        ...
        advice = generate_investment_advice(investment_problem)
